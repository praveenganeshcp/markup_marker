...
export class PrimaryButtonWidget extends Widget {
    constructor(element: HTMLElement) {
        super(element);
    }
}

applyMixins(PrimaryButtonWidget, [BoxShadow, PaddingStyleable, ContainerStyleable, Measurable, BorderStyleable]);